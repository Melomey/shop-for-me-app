...
function Register(props) {
  return (
    <>
     <div className="py-26 bg-[url('/src/assets/orange-bg.jpg')] h-screen bg-cover">
     <div className="max-w-lg mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
        <h1 className="text-xl font-bold text-center text-gray-700 dark:text-gray-200 mb-8">Sign Up</h1>
